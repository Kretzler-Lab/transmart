...
<html>
	...
	<form>
		...
		<tr>
			...
			<br/>
			<br/>
			Select <b>one</b> categorical variable from the Navigate Terms tree and drag it into the box. (e.g. Treatment Arm). A continuous variable may be categorized by enabling "Binning" below.
		    </td>
			...
			<br/>
			<br/>
			Select <b>two categorical variables</b> variables from the Navigate Terms tree and drag them into the box. (e.g. Metastasis vs. No Metastasis ). A continuous variable may be categorized by enabling "Binning" below.
		    </td>
		    <td id="subsetdivider" rowspan="21" valign="center" align="center" height="100%">
			<div style="margin: 15px; border: 1px solid black; background: black; width: 1px; height: 150px"></div>
		    </td>
			...
			<br/>
			<br/>
			Select <b>one or more categorical variables</b> from the Navigate Terms tree and drag them into the box (e.g. Race). A continuous variable may be categorized by enabling "Binning" below.
		    </td>
		</tr>

		<tr>
		    <td align="center">
			<input style="font: 9pt tahoma;float:right;" type="button"
			       onclick="forestPlotView.clear_high_dimensional_input('divIndependentVariable')" value="X"/> <br/>
			...
			<br/>
			<br/>
			Select <b>one</b> categorical variable from the Navigate Terms tree and drag it into the box. (e.g. Placebo Arm). A continuous variable may be categorized by enabling "Binning" below.
			<br/>
			<br/>
			<input style="font: 9pt tahoma;float:right;" type="button"
			       onclick="forestPlotView.clear_high_dimensional_input('divReferenceVariable')" value="X"/> <br/>
			<div id='divReferenceVariable' class="queryGroupIncludeSmall  excludeValuePopup leafNodesOnly"></div>
		    </td>
		    <td align="right" style="vertical-align:top;">
			<input style="font: 9pt tahoma;" type="button"
			       onclick="forestPlotView.clear_high_dimensional_input('divDependentVariable')" value="X"/> <br/>
			<div id='divDependentVariable' class="queryGroupIncludeLong  excludeValuePopup leafNodesOnly"></div>
			<br/>
			<br/>
			<input type="checkbox" id="chkAssumeNonEvent" title="Non Event Checkbox"/>
			Check this box to group together all subjects without a node specified above.
		    </td>
		    <td align="right" style="vertical-align:top;">
			<input style="font: 9pt tahoma;" type="button"
		       onclick="forestPlotView.clear_high_dimensional_input('divStratificationVariable')" value="X"/> <br/>
		...
		<tr>
			...
			<span class='AnalysisHeader'>
			    Binning&nbsp;&nbsp;&nbsp;
			    <input id="BinningToggle" type = "button" value="Enable" onClick="toggleBinningForest();"/>
			</span>
		    </td>
		</tr>
		<tr>
		...
		<table id="tblBinningTable" class="subsettable" style="margin: 10px; width: 90%; border: 0px none; border-collapse: collapse;">
			...
			<td rowspan="3" style="vertical-align:top;">
			    ...
			    <input type="checkbox" id="chkManualBinIndep"  style="display:none;"
				   onClick="manageBinsForest(document.getElementById('txtNumberOfBinsIndep').value,'Indep');"
				   checked="true" title="Manual Bin Independent"/>
			    <br/>
			    <br/>
			    <div id="divManualBinContinuousIndep" style="display: none;">
				<table style="border-style: solid; border-width: thin; border-collapse: collapse;" id="tblBinContinuousIndep">
				    <tr>
			...
			<td rowspan="3" style="vertical-align:top;">
			    ...
			    <input type="checkbox" id="chkManualBinReference"  style="display:none;"
				   onClick="manageBinsForest(document.getElementById('txtNumberOfBinsReference').value,'Reference');"
				   checked="true" title="Manual Bin Reference"/>
			    <br/>
			    <br/>
			    
			    <div id="divManualBinContinuousReference" style="display: none;">
				<table style="border-style: solid; border-width: thin; border-collapse: collapse;" id="tblBinContinuousReference">
				    <tr>
					<td colspan="3" align="center">Range</td>
				    </tr>
				</table>
		    ...
		    <tr>
			<td align="left">
			    <b>Number of Bins</b> : <input type="text" id="txtNumberOfBinsDep"
							   onChange="validateDependentBins(this.value);
								     manageBinsForest(this.value,'Dep');" value="2"
							   title="Number of Bins Dependent"/>
			</td>
			<td align="left">
			    <b>Number of Bins</b> : <input type="text" id="txtNumberOfBinsStratification"
							   onChange="manageBinsForest(this.value,'Stratification');" value="2"
							   title="Number of Bins Stratification"/>
			</td>
		    </tr>
		    <tr>
			<td align="left">
		    ...
		    <tr>
			<td>
			    <b>Manual Binning</b> : <input type="checkbox" id="chkManualBinDep"
							   onClick="manageBinsForest(document.getElementById('txtNumberOfBinsDep').value,'Dep');"
							   title="Manual Binning Dependent"/>
			</td>
			<td>
			    <b>Manual Binning</b> : <input type="checkbox" id="chkManualBinStratification"
							   onClick="manageBinsForest(document.getElementById('txtNumberOfBinsStratification').value,'Stratification');"
							   title="Manual Bin Stratification"/>
			</td>
		    </tr>
		    <tr>
			<td> &nbsp;</td>
