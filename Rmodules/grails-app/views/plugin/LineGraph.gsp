...
%{--		</a>--}%
		...
		<div class="container">
			...
			<fieldset class="inputFields">
				...
				<span class="hd-notes">
				    %{--Drag one or more <strong>numerical</strong> concepts from the Navigate Terms tree into the box below or--}%
				    %{--high dimensional node. The concepts must come from a data node (Biomarker Data or Clinical--}%
				    %{--Data).--}%

				    Drag one or multiple numerical or high dimensional nodes from the Navigate Terms tree into box below.
			...
			<fieldset class="inputFields">
				...
				<span class="hd-notes">
				    ...
				    Drag one or multiple nodes from the Navigate Terms tree into box below. Node should be categorical
