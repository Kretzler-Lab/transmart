...
<div id="dataAssociationBody">
	...
	<label for="cohortSummary">
		<span>Cohorts:</span>
		<span id="cohortWarningMsg" style="display:none; color: red">WARNING: You have not selected a study and the analysis will not work. Please go back to the Comparison tab and make a cohort selection.
		</span>
